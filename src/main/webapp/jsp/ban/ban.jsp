                        ...
                        <div class="table-responsive">
                            ...
                            <form action="${pageContext.request.contextPath}/controller" method="POST">
                                ...
                                <div class="button-container">
                                    <button id="btn-load3" class="button-small" onclick="loadCommand('load_ban_form')">
                                        <fmt:message key="label.create" bundle="${rb}"/></button>
                                    <button id="btn-load2" class="button-small" onclick="loadCommand('load_ban_form');"><fmt:message key="label.edit" bundle="${rb}"/></button>
                                    <button id="btn-load1" class="button-small" onclick="deleteCommand('delete_ban')"><fmt:message key="label.delete" bundle="${rb}"/></button>
                                </div>
                            </form>
                        </div>
                    </div>

...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/stylesheets/card.css">
</head>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <c:if test="${empty sessionScope.USER.car}">
                <c:if test="${empty requestScope.adminCarList}">
                    <form id="commandForm" action="${pageContext.request.contextPath}/controller" method="POST">
                        ...
                        <input type="submit" class="button" id="click" value="<fmt:message key="label.addCar" bundle="${rb}"/> "/>
                    </form>
                </c:if>
                <c:if test="${not empty requestScope.adminCarList}">
                            <div class="driver-form">
                                <form id="driverForm" action="${pageContext.request.contextPath}/controller" method="POST">
                                    ...
                                    <select id="carListId">
                                        ...
                                        <c:forEach var="car" items="${requestScope.adminCarList}">
                                            <option value="${car}">${car.mark} ${car.model}</option>
                                        </c:forEach>
                                    </select>
                                    <div class="top-row">
                                    ...
                                    <button type="submit" class="button button-block"><fmt:message key="label.submit" bundle="${rb}" />
                                </form>
                            </div>
                </c:if>
            </c:if>
